...
var promise = new Promise(function(fulfill, reject) {
  try {
    deleteAll().then(function() {
      ...
      // Type.findAll({attributes: ['name'], include: [{model: Type, as: 'weaknesses', attributes: ['name']},{model: Type, as: 'strengths',
      // attributes: ['name']}]}).then(function (types) {
...
function parseGameMaster() {
  return new Promise(function(fulfill, reject) {
    try {
      fs.readFile('./data/2_GAME_MASTER', function read(err, data) {
