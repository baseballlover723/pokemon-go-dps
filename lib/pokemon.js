...
Pokemon.prototype = {
    ...
    shouldUseChargeMove: function (options) {
        ...
        var chargeDPS = this.calculateChargeMoveDamage(options) / (this.chargeMove.duration + CHARGE_DELAY);
    ...
    calculateCycleDuration: function () {
        if (this.shouldUseChargeMove({stab: true})) {
            return this.calculateFastMoveDuration() + this.chargeMove.duration + CHARGE_DELAY;
        } else {
